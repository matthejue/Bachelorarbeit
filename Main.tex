...
\begin{document}
  ...
  listing file={#2},
  enhanced, colframe=PrimaryColor,colback=SecondaryColor, fonttitle=\bfseries, arc=0mm, #1, listing only, listing engine=minted, minted language=C, halign title=center, drop fuzzy shadow
  }
  % minted language=C,

  \newtcbinputlisting{\treebox}[2][]{
  listing file={#2},
  enhanced, colframe=PrimaryColor, colback=SecondaryColor, fonttitle=\bfseries, arc=0mm, #1, listing only, listing engine=listings, halign title=center, drop fuzzy shadow
  }
