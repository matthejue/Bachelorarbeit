...
\begin{document}
  ...
  listing file={#2},
  enhanced, colframe=PrimaryColor,colback=SecondaryColor, fonttitle=\bfseries, arc=0mm, #1, listing only, listing engine=minted, minted style=colorful, minted options={fontsize=\small,breaklines,autogobble, breakable}, halign title=center, sharpish corners, drop fuzzy shadow, minted options={linenos=false, numbersep=0mm}
  }
