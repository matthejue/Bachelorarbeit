...
\newtcbtheorem[list inside={theorem_list},crefname={definition}{definitions}]{Definition}{Definition}%
...
\newtcbinputlisting{\codebasdf}[2][]{
listing file={#2},
enhanced,colframe=PrimaryColor,colback=SecondaryColor, fonttitle=\bfseries, width=5cm, arc=0mm, #1, nobeforeafter, listing only, minted language=C}

\newtcblisting{treebox}[1][]{enhanced,colframe=PrimaryColor,colback=SecondaryColor, fonttitle=\bfseries, width=5cm, arc=0mm, #1, nobeforeafter, listing only}
