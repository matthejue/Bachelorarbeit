...
listing file={#2},
enhanced,colframe=PrimaryColor,colback=SecondaryColor, fonttitle=\bfseries, width=0.25\linewidth, arc=0mm, #1, nobeforeafter, listing only, minted language=C
}

\newtcbinputlisting{\treebox}[2][]{
listing file={#2},
enhanced, breakable, colframe=PrimaryColor, colback=SecondaryColor, fonttitle=\bfseries, width=0.25\linewidth, arc=0mm, #1, nobeforeafter, listing only
}
