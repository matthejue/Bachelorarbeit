...
\begin{Definition}{Abstrakte Syntax Tree}{abstrakte_syntax_tree}
  \colorbold{Compilerinterne Darstellung} eines Programs, welches aus einem \colorbold{Inputstring}, der in \colorbold{Konkretter Syntax} angegeben ist generiert wurde, die es erlaubt die Operationen, die der Compiler ausführen muss, möglichst effizient auszuführen.
