...
\begin{Special_Paragraph}
  Im Folgenden wird ein \colorbold{Compiler} als $C_w^o$ bezeichnet, wobei $C_w$ die \colorbold{Sprache} bezeichnet, die der Compiler als \colorbold{Input} nimmt und zu einer nicht näher spezifizierten Maschienensprache $L_B$ kompiliert. Fall die Notwendigkeit besteht die \colorbold{Maschiene} $M_i$ anzugeben, zu dessen \colorbold{Maschienensprache} der Compiler kompiliert, wird das als $C_{i\_W}$ geschrieben. Fall die Notwendigkeit besteht. Falls die Notwendigkeit besteht die \colorbold{Sprache} anzugeben, in der der Compiler selbst geschrieben ist, wird das mit $C^o$ bezeichnet.
