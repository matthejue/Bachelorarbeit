...
\begin{itemize}[itemsep=-1mm, topsep=-1mm]
  ...
  \coloritem[Chart Parser] Es wird \colorbold{Dynamische Programmierung} verwendet. Das macht das Parsen effizienter \colorbold{Kontextfreier Grammatiken} zu machen, sodass das, wobei.\footnote{Der \colorbold{\colorbold{Earley Parser}, den \colorbold{Lark} und damit der PicoC-Compiler verwendet fällt unter diese Kategorie}}
\end{itemize}
