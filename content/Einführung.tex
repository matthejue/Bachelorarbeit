...
Die \colorbold{Notation} setzt sich dabei aus den \colorbold{Bausteinen} für ein Program (Definition~\ref{def:t_diagram_program}), einen Übersetzer (Definition~\ref{def:t_diagram_uebersetzer}), einen Interpreter (Definition~\ref{def:t_diagram_interpreter}) und eine Maschiene (Definition~\ref{def:t_diagram_maschiene}) zusammen.

\begin{Definition}{T-Diagram Programm}{t_diagram_program}
  Es ist nicht notwendig den Namen der Sprache an ein $L$ dranzuhängen, weil hier immer eine Sprache steht.
  \begin{figure}[H]
    \centering
...
\begin{Definition}{T-Diagram Übersetzer}{t_diagram_uebersetzer}
  \begin{figure}[H]
    \centering
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{./figures/summarize_compiler.png}
  \caption{Mehrere T's entsprehcen einem Comipler.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{./figures/summarize_interpreter.png}
  \caption{und dann Intepretieren entspricht einem großen Interpreter.}
\end{figure}
