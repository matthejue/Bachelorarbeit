...
Will man die \colorbold{Operatoren} aus einer \colorbold{Programmiersprache} in einer \colorbold{Grammatik} für eine \colorbold{Konkrette Syntax} ausdrücken, so lässt sich das nach einem klaren Schema machen, wenn die \colorbold{Assoziativität} (Definiton~\ref{def:assoziativität}) und \colorbold{Präzidenz} (Definition~\ref{def:präzidenz}) dieser \colorbold{Operatoren} bekannt ist. Dieses Schema wird in Unterkapitel~\ref{sec:umsetzung_von_präzidenz} genauer erklärt.
