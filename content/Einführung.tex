...
\begin{Definition}{Reiner Ausdruck (bzw. pure expression)}{pure_expression}
  Ein \colorbold{Reiner Ausdruck} ist rein, wenn er keine \colorbold{Nebeneffekte} erzeugt.
  \footcite{g_siek_course_2022}
\end{Definition}

\begin{Definition}{Monadische Normalform}{monadische_normalform}
  Eine \colorbold{Konkrette Syntax} ist in \colorbold{Monadischer Normalform}, wenn sie \colorbold{reine} Ausdrücke und Ausdrücke, die \colorbold{nicht rein} sind
\end{Definition}
