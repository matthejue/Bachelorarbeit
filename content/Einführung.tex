...
Hat man es mit einer Sprache zu tuen, welche \colorbold{Unreine Ausdrücke} (Definition~\ref{def:unreiner_ausdruck}) besitzt, so ist es sinnvoll einen \colorbold{Pass} einzuführen, der \colorbold{reine} und \colorbold{unreine Ausdrücke} voneinander trennt. Das wird erreicht, indem man aus den \colorbold{Unreinen Ausdrücken} vorangestellte Statements macht, in denen die \colorbold{Komplexen Ausdrücke} \colorbold{temporären Locations} zugewiesen werden (Definiton~\ref{def:location}) und dann anstelle des \colorbold{Komplexen Ausdrucks} auf die jeweilige \colorbold{temporäre Location} zugegriffen wird.


\begin{Definition}{Reiner Ausdruck (bzw. pure expression)}{pure_expression}
  Ein \colorbold{Reiner Ausdruck} ist ein Ausdruck, der \colorbold{rein} ist. Das bedeutet, dass dieser Ausdruck \colorbold{keine Nebeneffekte} erzeugt. Ein \colorbold{Nebeneffekt} ist eine \colorbold{Bedeutung} eines Ausdrucks, die sich nicht mit \colorbold{RETI-Code} darstellen lässt.\footnote{Sondern z.B. \colorbold{intern} etwas am \colorbold{Kompilierprozess} ändert.}\footcite{g_siek_course_2022}
\end{Definition}

\begin{Definition}{Unreiner Ausdruck}{unreiner_ausdruck}
  Ein \colorbold{Unreiner Ausdruck} ist ein Ausdruck, der \colorbold{nicht rein} ist.
\end{Definition}

\begin{Definition}{Monadische Normalform}{monadische_normalform}
  Eine \colorbold{Konkrette Syntax} ist in \colorbold{Monadischer Normalform}, wenn sie \colorbold{reine Ausdrücke} und \colorbold{unreine Ausdrücke} \colorbold{nicht} miteinander \colorbold{mischt}, sondern voneinander \colorbold{trennt}.\footnote{Z.B. ist bei \smalltt{int var = 12} der Ausdruck mit dem \colorbold{Nebeneffekt} eine Variable zu \colorbold{allokieren:} \smalltt{int var}, mit dem Ausdruck für eine \colorbold{Zuweisung} $\mathtt{\langle exp\rangle = 12}$ gemischt.}\footcite{g_siek_course_2022}
\end{Definition}
...
\begin{Definition}{Atomarer Ausdruck}{atomarer_ausdruck}
  ...
  Präziser ist ein \colorbold{Ausdruck} ist \colorbold{atomar}, wenn er
\end{Definition}
...
\begin{Definition}{A-Normalform (ANF)}{a_normal_form}
  ...
  Eine \colorbold{Konkrette Syntax} ist in \colorbold{A-Normalform}, wenn alle \colorbold{Komplexen Ausdrücke} nur \colorbold{Atomare Ausdrücke} enthalten und einer \colorbold{Location} zugewiesen sind.
