...
\begin{Definition}{Mehrdeutige Grammatik}{mehrdeutige_grammatik}
  \enquote{Eine Grammatik ist \colorbold{mehrdeutig}, wenn es ein Wort $w\in L(G)$ gibt, das mehrere \colorbold{Syntaxbäume} zulässt}.\footnote{Alternativ, wenn es für $w$ \colorbold{mehrere} unterschiedliche \colorbold{Linksableitungen} gibt.}
  \footcite{nebel_theoretische_2020}
% TODO: (Bild hierfür)
\end{Definition}
