...
Ein \colorbold{Lexeme} ist damit aber nicht immer das gleiche, wie der \colorbold{Tokenwert}, denn z.B. im Falle von PicoC kann der Wert \smalltt{99} durch zwei verschiedene \colorbold{Literale} darstellt werden, einmal als ASCII-Zeichen \smalltt{'c'} und des Weiteren auch in Dezimalschreibweise als \smalltt{99}\footnote{Die Programmiersprache Python erlaubt es z.B. dieser Wert auch mit den Literalen \smalltt{0b1100011} und \smalltt{0x63} darzustellen.}. Der \colorbold{Tokenwert} ist jedoch der letztendlich verwendete Wert an sich, unabhängig von der Darstellungsform.
