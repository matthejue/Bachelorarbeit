...
\begin{itemize}[itemsep=-1mm, topsep=-1mm]
  ...
  \begin{itemize}[itemsep=-1mm, topsep=-1mm]
    \coloritem[Recursive-Descent / Backtracking Parser] Die Struktur dieser \colorbold{Parser} ist sehr nah an der \colorbold{Konkretten Syntax}, deren Sprache sie erkennen sollen\footnote{Diesesr Art von Parser wurde für den \colorbold{PicoC-Compiler} implementiert, als dieser noch auf dem Stand des \colorbold{Bachelorprojektes} war, bevor er durch den nicht selbst implementierten \colorbold{Earlay Parser} von Lark ersetzt wurde.}.
