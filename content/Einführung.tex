...
\begin{itemize}[itemsep=-2mm]
  ...
  \coloritem[Top-Down Parsing]
   % https://latex.org/forum/viewtopic.php?t=22612
  \vspace*{-0.5\baselineskip}
  \begin{itemize}[itemsep=-2mm]
    \coloritem asdf
  \end{itemize}
  \coloritem[Buttom-Up Parsing] Es wird mit dem Inputstring gestartet und versucht diesen durch Rückwärtsanwenden der \colorbold{Produktionen} der  \colorbold{Konkretten Syntax} bis zum  \colorbold{Startsymbol} zurückzuverfolgen.
  \vspace*{-0.5\baselineskip}
  \begin{itemize}[itemsep=-2mm]
    \coloritem asdf
  \end{itemize}
