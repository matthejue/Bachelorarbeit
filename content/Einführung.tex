...
\begin{itemize}[itemsep=-2mm, topsep=-2mm]
  \coloritem[Top-Down Parsing] asdf.
  \begin{itemize}[itemsep=-2mm, topsep=-2mm]
    \coloritem asd
  \end{itemize}
  \coloritem[Bottom-Up Parsing] Es wird mit dem Inputstring gestartet und versucht diesen durch Rückwärtsanwenden der \colorbold{Produktionen} der  \colorbold{Konkretten Syntax} bis zum  \colorbold{Startsymbol} zurückzuverfolgen.
  \begin{itemize}[itemsep=-2mm, topsep=-2mm]
