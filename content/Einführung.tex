...
\begin{figure}[H]
  ...
  \treebox[title=Tokenfolge, remember as=tokenfolge, width=0.6\linewidth, nobeforeafter]{./code_examples/example1.tokens}
  \hfill
  \treebox[title=Abstract Syntax Tree, remember as=abstract_sytax_tree, hbox, nobeforeafter]{./code_examples/example1.ast}
  \vspace{2cm}
  \treebox[title=Derivation Tree, remember as=derivation_tree, hbox]{./code_examples/example1.dt}
