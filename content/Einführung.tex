...
In Bezug auf einen Compilerbau hat ein Parser meist die Aufgabe aus einem \colorbold{Inputstring} einen \colorbold{Derivation Tree} (Definition \ref{def:derivation_tree}) zu generieren.
