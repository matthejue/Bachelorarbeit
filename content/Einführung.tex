...
Der \colorbold{Maschienencode}, denn ein üblicher \colorbold{Compiler} einer \colorbold{Programmiersprache} generiert, enthält die Maschienenbefehle üblicherweise in binärer Repräsentation, da diese in erster Linie für die Maschiene, die binär arbeitet verständlich sein sollen und nicht für den Programmierer. Ebenso wird bei komplexeren Compilern, die es erlauben, den Programmcode in mehrere Dateien aufzuteilen meist \colorbold{Objectcode} erzeugt.
% Der PicoC-Compiler
