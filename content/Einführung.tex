...
Diese \colorbold{Lexeme} werden vom \colorbold{Lexer} im \colorbold{Inputstring} identifziert und \colorbold{Tokens} $T$ zugeordnet (Definition \ref{def:lexer}). Die Tokens sind es, die letztendlich an die \colorbold{Syntaktische Analyse} weitergegeben werden.
...
Der Grund warum nicht einfach nur \colorbold{Lexeme} an die \colorbold{Syntaktische Analyse} weitergegeben werden ist, weil z.B. ein `Identifer`.
