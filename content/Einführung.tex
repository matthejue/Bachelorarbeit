...
Sollte es sich bei dem \colorbold{Komplexen Ausdruck} um einen \colorbold{Unreinen Ausdruck} handeln, welcher nur einen \colorbold{Nebeneffekt} ausführt und sich nichts in RETI-Befehle übersetzen lässt.

% A-Normalform ist Monadischer Normalform, nur das Reinheit zu Atotarität erweitert, Jede automare Ausdruck ist rein

% vorziehen, was mit -> a = b
...
Auf diese Weise sind alle \colorbold{Statements} und \colorbold{Ausdrücke} in \colorbold{A-Normalform} (Definition~\ref{def:a_normal_form}).
...
\begin{Definition}{Atomarer Ausdruck}{atomarer_ausdruck}
  Ein \colorbold{Atomarer Ausdruck} ist ein Ausdruck, der \colorbold{keine Nebeneffekte} hat und der in eine \colorbold{Folge von RETI-Befehlen} übersetzt werden kann, die \colorbold{atomar} ist, also \colorbold{nicht} mehr weiter in kleinere Folgen von RETI-Befehlen \colorbold{zerkleinert} werden kann, welche die \colorbold{Übersetzung} eines anderen Ausdrucks sind.
