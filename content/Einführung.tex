...
\begin{figure}[H]
  \centering
  \treebox[title=Tokenfolge, remember as=tokenfolge, width=0.5\linewidth, nobeforeafter]{./code_examples/example1.tokens}
  \hfill
  \treebox[title=Abstract Syntax Tree, remember as=abstract_sytax_tree, width=0.4\linewidth, nobeforeafter]{./code_examples/example1.ast}
  \vspace{2cm}
