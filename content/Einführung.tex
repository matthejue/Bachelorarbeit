...
\begin{figure}[H]
  \codebox[title=Inputstring, remember as=inputstring, hbox, nobeforeafter]{./code_examples/example1.picoc}
  \hfill
  \codebox[title=Tokenfolge, remember as=tokenfolge, width=0.6\linewidth, nobeforeafter]{./code_examples/example1.tokens}
...
\begin{figure}[H]
  ...
  \codebox[title=Tokenfolge, remember as=tokenfolge, width=0.6\linewidth, nobeforeafter]{./code_examples/example1.tokens}
  \hfill
  \codebox[title=Abstract Syntax Tree, remember as=abstract_sytax_tree, hbox, nobeforeafter]{./code_examples/example1.ast}
  \vspace{2cm}
  \codebox[title=Derivation Tree, remember as=derivation_tree, hbox]{./code_examples/example1.dt}
