...
\end{Definition}
  ...
  \newtcblisting{codebox}[1][]{enhanced,colframe=PrimaryColor,colback=SecondaryColor, fonttitle=\bfseries, width=5cm, arc=0mm, #1, nobeforeafter, listing only, minted language=C}
