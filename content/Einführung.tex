...
\begin{Definition}{Immediate}{immediate}
  \colorbold{Konstanter Wert}, der als \colorbold{Teil} eines \colorbold{Maschienenbefehls} gespeichert ist und dessen \colorbold{Wertebereich} dementsprechend auch durch die die Anzahl an Bits, die ihm innerhalb dieses \colorbold{Maschienenbefehls} zur Verfügung gestellt sind, \colorbold{beschränkter} ist als bei sonstigen Werten innerhalb des Hauptspeichers, denen eine ganze Speicherzelle zur Verfügung steht.
\end{Definition}
