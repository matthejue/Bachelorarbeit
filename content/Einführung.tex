...
Die \colorbold{Notation} setzt sich dabei aus den \colorbold{Bausteinen} für ein Program (Definition~\ref{def:t_diagram_program}), einen Übersetzer (Definition~\ref{def:t_diagram_compiler}), einen Interpreter (Definition~\ref{def:t_diagram_interpreter}) und eine Maschiene (Definition~\ref{def:t_diagram_maschiene}) zusammen.
...
\begin{Definition}{T-Diagram Compiler}{t_diagram_compiler}
  Repräsentiert einen \colorbold{Compiler}, der in der \colorbold{Sprache} $L_1$ geschrieben ist und \colorbold{Programme} von der \colorbold{Sprache} $L_2$ in die \colorbold{Sprache} $L_3$ kompiliert.
  \begin{figure}[H]
    \centering
...
\begin{Definition}{T-Diagram Maschiene}{t_diagram_maschiene}
  Repräsentiert eine \colorbold{Maschiene}, welche die \colorbold{Maschienensprache} ausführt.
  \begin{figure}[H]
    \centering
...
Sowohl horinzontal und vertikal kann man
