...
\begin{Definition}{Literal}{literal}
  Eine von möglicherweise vielen weiteren \colorbold{Darstellungsformen} (als \colorbold{Zeichenkette}) für ein und denselben \colorbold{Wert} eines \colorbold{Datentyps}. % (Definition~\ref{def:datentyp}).
  \begin{figure}[H]
    \centering
...
% \begin{Definition}{Datentyp}{datentyp}
%   Eine Struktur, die
% \end{Definition}
