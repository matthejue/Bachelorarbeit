...
\begin{Definition}{Bootstrapping}{bootstrapping}
  ...
  Wenn es auf der Zielmaschine noch gar keinen Compiler für die höhere Programmiersprache gibt, in der der Compiler für ebendiese höhere Programmiersprache geschrieben steht, so liegt eine \colorbold{zirkulare Abhängigkeit vor}, die man nur auflösen kann, indem eine \colorbold{externe Entität} zur Hilfe nimmt. Z.B. indem man einen \colorbold{Cross-Compiler} auf einer anderen Maschine nutzt, die
