...
\NewDocumentCommand{\arith}{s}{%
  ...
  \otherform{UnOp(\langle un\_op\rangle , \langle exp\rangle ) \gralt Call(Name('input'), [])}{}
}
...
\NewDocumentCommand{\arithanf}{s}{%
  ...
  \firstcase{exp}{\textcolor{gray!90!black}{Name(str) \gralt Num(str) \gralt Char(str)} \gralt Global(Num(str))}{}
  \IfBooleanT{#1}{%
    \downplay
  }
  ...
  \otherform{UnOp(\langle un\_op\rangle, Stack(Num(str))) \gralt Call(Name('input'), [])}{}
}
...
\NewDocumentCommand{\assign}{s}{%
  ...
  \firstcase{exp}{Alloc(\langle type\_qual\rangle , \langle dataype\rangle , Name(str))}{}
  \IfBooleanT{#1}{%
    \downplay
  }
...
\NewDocumentCommand{\assignanf}{s}{%
  ...
  \firstcase{stmt}{Assign(Stack(Num(str)), Stack(Num(str)))}{}
  \downplay
  \otherform{Exp(\langle exp\rangle)}{}
}
...
\NewDocumentCommand{\pntr}{s}{%
  ...
  \firstcase{exp}{Deref(\langle exp\rangle , \langle exp\rangle )}{}
  \IfBooleanT{#1}{%
    \downplay
  }
...
\NewDocumentCommand{\pntrshrink}{s}{%
  ...
  \firstcase{exp}{\lochighlight{Deref(\langle exp\rangle , \langle exp\rangle )}}{}
  \IfBooleanT{#1}{%
    \downplay
  }
  \otherform{Ref(\langle exp\rangle )}{}
...
\NewDocumentCommand{\arrayanf}{s}{%
  ...
  \firstcase{exp}{Subscr(Stack(Num(str)), Stack(Num(str))) \gralt Array(\langle exp\rangle +)}{}
}
...
\NewDocumentCommand{\ifelseanf}{s}{%
  ...
  \firstcase{stmt}{IfElse(\langle Stack(Num(str))\rangle , \langle stmt\rangle *, \langle stmt\rangle *)}{L\_If\_Else}
}
