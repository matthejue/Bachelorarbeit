...
\NewDocumentCommand{\picocleftover}{s}{%
  \ignorespaces
  \IfBooleanTF{#1}{%
    \firstcase{instr}{\textcolor{gray!90!black}{Exp(GoTo(str)) \gralt GoTo(Name(str))} \gralt Exit(Num(str))}{L\_PicoC}
  }{
    \downplay
    \firstcase{instr}{Exp(GoTo(str)) \gralt GoTo(Name(str))}{L\_PicoC}
  }
  \IfBooleanTF{#1}{%
    \downplay
...
\NewDocumentCommand{\retiblocks}{s}{%
  ...
  \otherform{SingleLineComment(str, str) \gralt Instr(Loadi(), [Reg(Acc()), GoTo(Name(str))])}{}
  \otherform{Jump(Always(), Im(str(distance)))}{}
  \IfBooleanT{#1}{%
...
\NewDocumentCommand{\reti}{s}{%
  ...
  \otherform{RTI() \gralt Call(Name('print'), \langle reg\rangle ) \gralt Call(Name('input'), \langle reg\rangle )}{}
  \downplay
  \otherform{SingleLineComment(str, str) \gralt Instr(Loadi(), [Reg(Acc()), Im("1")])}{}
  \firstcase{program}{Program(Name(str), \langle instr\rangle *)}{}
}
