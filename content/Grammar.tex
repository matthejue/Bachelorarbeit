...
\NewDocumentCommand{\arith}{s}{%
  ...
  \otherform{UnOp(\langle un\_op\rangle , \langle exp\rangle ) \gralt Call(Name('input'\,\mid\, 'print'), Empty())}{}
  \IfBooleanT{#1}{%
    \downplay
  }
  \otherform{Exp(Call(Name('input'), Empty()))}{}
  \otherform{Exp(Call(Name('print'), Empty()))}{}
}
...
\NewDocumentCommand{\pntranf}{s}{%
  ...
  \firstcase{datatype}{PntrDecl(Num(str), \langle datatype\rangle )}{L\_Pntr}
  \otherform{Ref(\langle Name(str)\rangle)}{}
  \otherform{Ref(\langle Subscr(\langle exp\rangle, Num(str))\rangle)}{}
  \otherform{Ref(\langle Attr(\langle exp\rangle, Name(str))\rangle)}{}
}
...
\NewDocumentCommand{\funanf}{s}{%
  ...
  \firstcase{stmt}{StackMalloc(Num(str)) \gralt NewStackframe(Name(str), GoTo(str))}{L\_Fun}
