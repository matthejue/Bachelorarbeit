...
\begin{figure}[H]
  \centering
  \codebox[remember as=pointer_dereferenzierung_picoc_code, hbox]{./code_examples/example_pntr_deref.picoc}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=pointer_dereferenzierung_ast, hbox]{./code_examples/example_pntr_deref.ast}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=pointer_dereferenzierung_picoc_shrink, hbox]{./code_examples/example_pntr_deref.picoc_shrink}
...
\subsubsection{Definition von Arrays}
% Stack und Globale Statische Daten
...
\begin{figure}[H]
  \centering
  \codebox[remember as=array_init_picoc_code, hbox]{./code_examples/example_array_init.picoc}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=array_init_ast, hbox]{./code_examples/example_array_init.ast}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=array_init_picoc_mon, hbox]{./code_examples/example_array_init.picoc_mon}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=array_init_reti_blocks, hbox]{./code_examples/example_array_init.reti_blocks}
...
\begin{figure}[H]
  \centering
  \codebox[remember as=array_access_picoc_code, hbox]{./code_examples/example_array_access.picoc}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=array_access_ast, hbox]{./code_examples/example_array_access.ast}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=array_access_picoc_mon, hbox]{./code_examples/example_array_access.picoc_mon}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=array_access_reti_blocks, hbox]{./code_examples/example_array_access.reti_blocks}
...
\begin{figure}[H]
  \centering
  \codebox[remember as=array_assignment_picoc_code, hbox]{./code_examples/example_array_assignment.picoc}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=array_assignment_ast, hbox]{./code_examples/example_array_assignment.ast}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=array_assignment_picoc_mon, hbox]{./code_examples/example_array_assignment.picoc_mon}
...
\begin{figure}[H]
  \centering
  \treebox[remember as=array_assignment_reti_blocks, hbox]{./code_examples/example_array_assignment.reti_blocks}
...
\subsubsection{Definition von Structs}
% Stack und Globale Statische Daten
