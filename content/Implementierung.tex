...
Der Zugriff auf einen bestimmten  Index eines Arrays ist wie folgt umgesetzt:
  ...
  \begin{figure}
    \treebox[remember as=array_access_picoc_code, width=0.6\textwidth, breakable]{./code_examples/example_array_access.picoc}
  \end{figure}
  \vspace{0.5cm}
  \treebox[remember as=array_access_ast, width=0.6\textwidth, breakable]{./code_examples/example_array_access.ast}
