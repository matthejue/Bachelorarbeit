...
\subsection{Umsetzung der Derived Datatypes allgemein}
...
\begin{code}
  \centering
  \numberedcodebox[minted language=c]{./code_examples/example_var_def_derived_dts.picoc}
  \caption{PicoC Code für unterschiedliche Adressberechnung bei Globalen Statischen Daten und Stackframe}
  \label{fig:picoc_code_für_unterschiedliche_adressberechnung_bei_globalen_statischen_daten_und_stackframe}
\end{code}

\begin{code}
  \centering
  \numberedcodebox[breakable, minted language=text]{./code_examples/example_var_def_derived_dts.st}
  \caption{Symboltabelle für unterschiedliche Adressberechnung bei Globalen Statischen Daten und Stackframe}
  \label{fig:symboltabelle_für_unterschiedliche_adressberechnung_bei_globalen_statischen_daten_und_stackframe}
\end{code}

\subsubsection{Mittelteil für Globale Statische Daten und Stackframe}
\begin{code}
  \centering
...
\subsubsection{Schlussteil für Globale Statische Daten und Stackframe}
...
\begin{code}
  \centering
  \numberedcodebox[minted language=c, minted options={highlightlines={1,8}}]{./code_examples/example_fun_call_by_sharing_array.picoc}
...
\begin{code}
  \centering
  \numberedcodebox[minted language=text, breakable, minted options={highlightlines={15,24}}]{./code_examples/example_fun_call_by_sharing_array.st}
...
% \begin{code}
%   \centering
%   \numberedcodebox[minted language=text, breakable, minted options={highlightlines={44, 46, 62, 64}}]{./code_examples/example_fun_call_by_value_struct.st}
%   \caption{Symboltabelle für Call by Value für Structs}
%   \label{fig:symboltabelle_für_call_by_value_for_structs}
% \end{code}
