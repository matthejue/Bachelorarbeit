...
\begin{code}
  \centering
  \numberedcodebox[minted language=c, minted options={highlightlines=1}]{./code_examples/example_fun_def.picoc}
...
\begin{code}
  \centering
  \numberedcodebox[minted language=text, breakable, minted options={highlightlines={15,24}}]{./code_examples/example_fun_def.st}
  \caption{Symboltabelle für eine Funktionsdefinition}
  \label{fig:symboltabelle_für_eine_funktionsdefinition}
\end{code}
