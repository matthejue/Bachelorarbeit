...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_pntr_deref.picoc}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_pntr_deref.ast}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_pntr_deref.picoc_shrink}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_init.picoc}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_init.ast}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_init.picoc_mon}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_init.reti_blocks}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_access.picoc}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_access.ast}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_access.picoc_mon}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_access.reti_blocks}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_assignment.picoc}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_assignment.ast}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_assignment.picoc_mon}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_array_assignment.reti_blocks}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_variable_definition_derived_datatypes_global_static_data.picoc}
...
{
  \centering
  \numberedcodebox[breakable]{./code_examples/example_variable_definition_derived_datatypes_global_static_data.st}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_function_call_no_return_value.picoc}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_function_call_no_return_value.picoc_mon}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_function_call_no_return_value.reti_blocks}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_function_call_no_return_value.reti}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_function_call_with_return_value.picoc}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_function_call_with_return_value.picoc_mon}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[]{./code_examples/example_function_call_with_return_value.reti_blocks}
...
\begin{figure}[H]
  \centering
  \numberedcodebox[minted_language=c]{./code_examples/example_function_call_with_return_value.reti}
