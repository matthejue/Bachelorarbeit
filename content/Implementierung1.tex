...
\begin{grammar}[Konkrette Syntax für die Lexikalische Analyse in EBNF, Teil 1][H][gr:concrete_syntax_lex]
  \toprule
...
\begin{grammar}[Konkrette Syntax für die Lexikalische Analyse in EBNF, Teil 2][H][gr:concrete_syntax_lex]
  \toprule
