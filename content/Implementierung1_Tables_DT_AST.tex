...
Es sind hierbei mehrere Probleme zu lösen. Hat man den Ausdruck \smalltt{struct st *(*var)[3][2]} wird dieser zu einem  \colorbold{Derivation Tree}, wie er in Abbildung~\ref{fig:derivation_tree_nach_parsen_eines_ausdrucks} zu sehen ist.
...
\begin{figure}[H]
  ...
  \hfill
  \codebox[title=Derivation Tree, remember as=derivation_tree, hbox, nobeforeafter, minted language=c]{./code_examples/derivation_tree_simplified_dt.special}
  \hspace{2cm}
...
\begin{figure}[H]
  \hspace{2cm}
  \codebox[title=Ausdruck, remember as=derivation_tree, hbox, nobeforeafter, minted language=c]{./code_examples/derivation_tree_simplified_dt.special}
  \hfill
  \codebox[title=Derivation Tree, remember as=derivation_tree_simple, hbox, nobeforeafter, minted language=c]{./code_examples/derivation_tree_simplified_dt_simple.special}
  \hspace{2cm}
