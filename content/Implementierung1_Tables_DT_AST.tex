...
Die \colorbold{Abstrakte Syntax} der Sprache $L_{PicoC}$ wird durch die Grammatik~\ref{gr:abstract_syntax_l_picoc} beschrieben.
...
In Code~\ref{code:picoc_code_nach_derivation_tree_vereinfachung} ist der \colorbold{Abstract Syntax Tree} aus Code~\ref{code:derivation_tree_nach_derivation_tree_generierung} nach der Generierung mithilfe eines \colorbold{Transformers} zu sehen.
