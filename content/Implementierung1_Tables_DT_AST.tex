...
\begin{grammar}[Undurchdachte Konkrette Syntax der Sprache $L_{PicoC}$ für die Syntaktische Analyse in EBNF][H][gr:undurchdachte_konkrette_syntax]
  ...
  \firstcase{bin\_op}{\dq *\dq\gralt \dq /\dq\gralt \dq \%\dq \gralt \dq+\dq\gralt \dq-\dq\gralt \& \gralt {\wedge{}} \gralt {\mid}
  \otherform{{<} \gralt {<=} \gralt {>} \gralt {>=} \gralt {!=} \gralt {==} \gralt {\&\&} \gralt {\mid\mid}}{}
