...
Die \colorbold{Abstrakte Syntax} des \colorbold{PicoC-Shrink Passes} ist \colorbold{identisch} mit der \colorbold{Abstrakten Syntax} der Sprache $L_{PiocC}$ aus Unterkapitel~\ref{gr:abstract_syntax_l_picoc}, nach welcher der erste \colorbold{Abstract Syntax Tree} in der \colorbold{Syntaktischen Analyse} generiert wurde.
...
\begin{Special_Paragraph}
  Die \colorbold{Abstrakte Syntax} in Tabelle~\ref{gr:abstract_syntax_l_picoc_blocks} ist als Erweiterung bzw.
