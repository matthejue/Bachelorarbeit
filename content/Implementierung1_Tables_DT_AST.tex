...
Bei z.B. der Produktion \smalltt{un\_exp} in \ref{pr:un_exp} für die \colorbold{rechtsassoziativen unären Operatoren} \verb|-a|, \smalltt{!a $\thicksim$a}, \verb|*a| und \verb|&a| ist die \colorbold{Alternative} \smalltt{un\_op un\_exp} dafür zuständig, dass die unären Operatoren \colorbold{rechtsassoziativ} geschachtelt werden können (z.B. \smalltt{!-~42}). Die Alterantive \smalltt{post\_exp}  ist dafür zuständig, dass die Produktion auch \colorbold{terminieren} kann und es auch möglich ist auschließlich einen Ausdruck \colorbold{höherer Präzidenz}, wie \smalltt{42} zu haben.
...
Bei z.B. der Produktion \smalltt{post\_exp} in \ref{post_exp} für die \colorbold{linksassoziativen unären Operatoren} \verb|a()|, \verb|a[]| und \verb|a.b| ist die Alternative
...
% TODO: die Sache mit Linksrekursiv
