...
\begin{figure}[H]
  \begin{Code_Frame}[remember as=anfangsteil]{Anfangsteil}
    \codebox[title=Inputstring, width=0.3\linewidth, nobeforeafter, minted language=text]{./code_examples/ubersicht_anfangsteil_global.special_reti}
    \hfill
    \codebox[title=Tokenfolge, width=0.3\linewidth, nobeforeafter, minted language=text]{./code_examples/ubersicht_anfangsteil_stackframe.special_reti}
  \end{Code_Frame}
  \vspace{1cm}
  \begin{Code_Frame}[remember as=mittelteil]{Mittelteil}
    \codebox[title=Inputstring, width=0.3\linewidth, nobeforeafter, minted language=text]{./code_examples/ubersicht_mittelteil_pntr.special_reti}
    \hfill
    \codebox[title=Tokenfolge, width=0.3\linewidth, nobeforeafter, minted language=text]{./code_examples/ubersicht_mittelteil_array.special_reti}
    \hfill
    \codebox[title=Tokenfolge, width=0.3\linewidth, nobeforeafter, minted language=text]{./code_examples/ubersicht_mittelteil_struct.special_reti}
  \end{Code_Frame}
  \vspace{1cm}
  \begin{Code_Frame}[remember as=schlussteil]{Schlussteil}
    \codebox[title=Inputstring, width=0.3\linewidth, nobeforeafter, minted language=text]{./code_examples/ubersicht_schlussteil_struct_int_char.special_reti}
    \hfill
    \codebox[title=Tokenfolge, width=0.3\linewidth, nobeforeafter, minted language=text]{./code_examples/ubersicht_schlussteil_struct_int_char.special_reti}
  \end{Code_Frame}
