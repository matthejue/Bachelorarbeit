...
Im \colorbold{PicoC-Mon Pass} in Code~\ref{code:picoc_mon_pass_schlussteil} wird das eben angesprochene auf den \colorbold{Stack} speichern des \colorbold{Inhalts} der berechneten \colorbold{Adresse} mit der Komposition \smalltt{Exp(Stack(Num('1')))} dargestellt.
