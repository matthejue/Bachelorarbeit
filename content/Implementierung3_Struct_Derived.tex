...
Der \colorbold{Mittelteil}, bei dem die \colorbold{Startadresse} / \colorbold{Adresse} einer Aneinandereiheung von Zugriffen auf \colorbold{Pointerelemente}, \colorbold{Arrayelemente} oder \colorbold{Structattribute} berechnet wird (z.B. \smalltt{(*complex\_var.ar)[0]}), wird im Folgenden mithilfe des Beispiels in Code~\ref{code:picoc_code_mittelteil} erklärt.
