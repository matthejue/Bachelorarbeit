...
Ein \colorbold{Funktionsaufruf} mit \colorbold{Rückgabewert} (z.B. \smalltt{stack\_fun(local\_var)}), wird im Folgenden mithilfe des Beispiels in Code~\ref{code:picoc_code_für_funktionsaufruf_mit_rückgabewert} erklärt.
...
Im \colorbold{Abstract Syntax Tree} in Code~\ref{code:abstract_syntax_tree_} wird
