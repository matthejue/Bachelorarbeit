...
\begin{Special_Paragraph}
  ...
  Die Berechnug der \colorbold{Distanz} für den Sprung zum \colorbold{ersten} Befehl eines im \colorbold{Pass} zuvor \colorbold{existenten Blockes} erfolgt dabei nach der folgenden Formel:
  ...
  \[
    distanz = \begin{dcases}
      \parbox[t]{6cm}{$\#Befehle_{vor\, akt.\, Block} - \#Befehle_{vor\, Zielblock} + idx$} & \#Befehle_{vor\, Zielblock} < \#Befehle_{vor\, akt.\, Block} \\
     -idx & \#Befehle_{vor\, Zielblock} = \#Befehle_{vor\, akt.\, Block} \\
     \parbox[t]{6cm}{$\#Befehle_{vor\, Zielblock} - (\#Befehle_{vor\, akt.\, Block} - \#Befehle_{vor\, Zielblock}) + (\#Befehle_{vor\, akt.\, Block} - idx)$} & \#Befehle_{vor\, Zielblock} > \#Befehle_{vor\, akt.\, Block}
    \end{dcases}
  \]
