...
\begin{titlepage}
  ...
  \tcbset{skin=enhanced,
    title style={preaction={opacity=1, fill=gray}, pattern=fivepointed stars, pattern  color=white, opacity=0.1, rule=0mm},
    interior style={preaction={opacity=0.2, fill=gray}, pattern=fivepointed stars, pattern  color=white, opacity=0.3, rule=0mm},
